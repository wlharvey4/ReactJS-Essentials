...
#+BEGIN_SRC js :tangle snapterest/source/app.js :mkdirp yes
var React = require('react');
var ReactDOM = require('react-dom');
...
provifde ~document.getElementById('react-application')~ as a deployment target
