...
*** Create a ~package.json~ For Our Snapterest Project
:PROPERTIES:
...
#+NAME:run yarn init
#+BEGIN_SRC sh :exports both :results output :dir snapterest
...
<<Browserify>>*[[*Browserify][Browserify]]* is a tool used for bundling all your dependency
