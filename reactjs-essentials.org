...
#+BEGIN_SRC js :tangle snapterest/source/components/Header.react.js :mkdirp yes
var React = require('react');
...
#+BEGIN_SRC js :tangle snapterest/source/components/Tweet.react.js :mkdirp yes
var React = require('react');
