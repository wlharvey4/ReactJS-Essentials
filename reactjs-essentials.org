...
#+BEGIN_SRC js :tangle snapterest/source/components/Application.react.js :mkdirp yes :noweb yes
...
#+BEGIN_SRC js :tangle snapterest/source/components/Collection.react.js :mkdirp yes :noweb yes
<<Collection imports>>
...
#+BEGIN_SRC js :tangle snapterest/source/components/Stream.flux.react.js :noweb yes :mkdirp yes
...
#+BEGIN_SRC js :tangle snapterest/source/stores/Collection.js :mkdirp yes :noweb yes
...
#+BEGIN_SRC js :tangle: snapterest/source/actions/CollectionActionCreators.js :mkdirp yes :noweb yes
var AppDispatcher = require('../dispatcher/AppDispatcher');
...
#+BEGIN_SRC js :tangle snapterest/source/components/Application.flux.react.js :mkdirp yes :noweb yes
<<Application Dependencies>>
...
component has become much simply, and its markup, visually, looks much cleaner
...
#+BEGIN_SRC js :tangle snapterest/source/components/Collection.flux.react.js :mkdirp yes :noweb yes
<<Collection imports>>
...
#+BEGIN_SRC js :tangle snapterest/source/components/CollectionControls.react.flux.js :mkdirp yes :noweb yes
<<CollectionControls imports>>
...
#+BEGIN_SRC js :tangle snapterest/source/components/TweetList.flux.react.js :mkdirp yes :noweb yes
<<TweetList imports>>
