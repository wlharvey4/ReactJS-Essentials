...
let's install the [[https://www.npmjs.com/package/babelify][~babelify~ module]] ([[*Babelify][Babelify]]) [fn::See [[https://github.com/fedosejev/react-essentials/blob/master/updates.md#chapter-1-page-14][errata]]; The book uses
...
**** Installing Vinyl-Source-Stream Module
...
Create a small example ~gulpfile.js~ in your ~<dir>/snapterest/~ directory and
