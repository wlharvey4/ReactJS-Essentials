...
#+BEGIN_SRC js :tangle snapterest/gulpfile.js :eval no-export
...
#+BEGIN_SRC sh :dir snapterest :results output :exports none :eval no-export
gulp
#+END_SRC
