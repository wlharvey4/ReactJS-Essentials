...
** TODO Install Jest 0.4                                          :noexport:
...
module.exports.getListOfTweetIds;
#+END_SRC
...
- See [[https://github.com/fedosejev/react-essentials/blob/master/updates.md#chapter-8-page-6][Errata]]
  : npm install --save-dev jest-cli@^0.4
  : yarn add jest-cli@^0.4 --dev

[[shell:cd%20snapterest%20&&%20yarn%20add%20jest-cli@^0.4%20--dev][Install Jest-CLI 0.4]]
