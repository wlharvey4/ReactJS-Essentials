...
#+ATTR_TEXINFO: :alt img/ch2-ReactElement-children-param-50.png
[[file:img/ch2-ReactElement-children-param-50]]
...
#+ATTR_TEXINFO: :alt img/ch2-ReactElement-children-param-section-50.png
[[file:img/ch2-ReactElement-children-param-section-50]]
...
#+ATTR_TEXINFO: :alt img/ch2-ReactElement-children-factory-function-50.png
[[file:img/ch2-ReactElement-children-factory-function-50]]
...
#+ATTR_TEXINFO: :alt img/ch2-ReactElement-children-jsx-50.png
[[file:img/ch2-ReactElement-children-jsx-50]]
...
propTypes: {
    propertyName: function (properties, propertyName, componentName) {
        // ... validation failed				(ref:tweet-validator)
...
#+HEADER: :noweb yes :eval no
#+BEGIN_SRC js -n -r :tangle snapterest/source/components/Collection.react.js :mkdirp yes
<<Collection imports>>
...
Take a look at the component's [[(Collection-render)][~render()~ method, line (Collection-render)]].

#+NAME:Collection.render
#+BEGIN_SRC js -n :noweb yes :eval no :exports none
...
#+BEGIN_SRC js :eval no
var tweets = this.props.tweets;				(ref:four-variables)
...
#+BEGIN_SRC js -r :tangle snapterest/source/components/TweetList.react.js
<<TweetList imports>>
...
#+BEGIN_SRC js :exports none :eval no
getTweetElement: function (tweetId) {		(ref:tweet-in-li)
...
#+BEGIN_SRC js :exports none :eval no
    ...
    if (handleRemoveTweetFromCollection) {	(ref:scenario1)
        ...
        tweetElement = <Tweet tweet={tweet} />;	(ref:scenario2)
    }
...
#+ATTR_TEXINFO: :alt img/flux-diagram-white-background-25.png
[[file:img/flux-diagram-white-background-25]]
...
#+ATTR_TEXINFO: :alt img/flux-simple-f8-diagram-with-client-action-1300w-50.png
[[file:img/flux-simple-f8-diagram-with-client-action-1300w-50]]
