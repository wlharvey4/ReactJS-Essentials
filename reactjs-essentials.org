...
#+BEGIN_SRC emacs-lisp :exports both :results output
(if (not (assq 'js org-babel-load-languages)) (and (require 'ob-js) (print "JavaScript enabled.")))
(if (not (assq 'sh org-babel-load-languages)) (and (require 'ob-shell) (print "Shell enabled.")))
#+END_SRC
...
#+HEADER: :dir snapkite/snapkite-engine/filters :results silent :exports both
#+BEGIN_SRC sh
...
- [[#Snapkite Engine][Snapkite Engine]]
  ...
  + [[install-Snapkite-filters][Install Snapkite Filters]]
    ...
    - [[is-retweet-filter][is retweet]]
    - [[has-text-filter][has text]]
n  + [[configure-Snapkite-filters][Configure Snapkite Filters]]
...
#+begin_src emacs-list :exports results :results output
(org-babel-tangle)
#+end_src
