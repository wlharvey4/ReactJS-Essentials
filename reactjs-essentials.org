...
#+NAME: add keys to config.json
#+HEADER: :eval query-export
#+BEGIN_SRC sh :dir snapkite/snapkite-engine :results output :exports both
. ~/.bashrc
echo TWITTER_CONSUMER_KEY is $TWITTER_CONSUMER_KEY
sed -E -i '.bak' -e '/api/ s/\{\}/\{\
      \"consumerKey\": \"'$TWITTER_CONSUMER_KEY'\",\
      \"consumerSecret\": \"'$TWITTER_CONSUMER_SECRET'\",\
      \"accessTokenKey\": \"'$TWITTER_ACCESS_TOKEN_KEY'\",\
      \"accessTokenSecret\": \"'$TWITTER_ACCESS_TOKEN_SECRET'\"\
    \}/' -e '/trackKeywords/ s/\"trackKeywords\".*/\"trackKeywords\": \"my\",/' \
config.json
cat config.json
#+END_SRC

#+RESULTS: add keys to config.json
#+begin_example
TWITTER_CONSUMER_KEY is PcBwCyec2ue7aQwRaklWaprvA
{
  "application": {
    "pushTweets": true,
    "storeTweets": false,
...
##+HEADER: :eval query-export
#+HEADER: :dir snapkite/snapkite-engine/filters :exports code
#+BEGIN_SRC sh
...
#+COMMENT: TODO---make this code conditional on not already being done
