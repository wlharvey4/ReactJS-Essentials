...
#+BEGIN_SRC sh :dir snapkite/snapkite-engine :results value silent :exports both
...
##+HEADER: :eval query-export
#+HEADER: :dir snapkite/snapkite-engine/filters :exports both
#+BEGIN_SRC sh
